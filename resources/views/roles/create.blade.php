...
<div class="row">
    <div class="col-12">
        <h4>{{ __('message.role.addRole') }}</h4>
        <div class="card">
            <div class="card-header">
                <!-- Add role form -->
                {!! Form::open(array('route' => 'roles.store','method'=>'POST')) !!}
                <div class="col-12">
                    <label class="form-label" for="modalRoleName">{{ __('message.Role Name') }}</label>
                ...
                <div class="col-12">
                    <h5 class="mb-1 mt-6">{{ __('message.Role Permissions') }}</h5>
                    <!-- Permission table -->
                                ...
                                <td>
                                    <div class="d-flex justify-content-end">
                                        <div class="form-check mb-0">
                                            ...
                                            <label class="form-check-label" for="selectAll">{{ __('message.Select All') }} </label>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="col-12 mt-4 text-center">
                    <a href="{{ route('roles.index') }}" class="btn btn-label-secondary float-start">{{ __('message.common.cancel') }} </a>
                    <button type="submit" class="btn btn-primary float-end">{{ __('message.common.submit') }}</button>
                </div>
                {!! Form::close() !!}
                <!--/ Add role form -->
            </div>
