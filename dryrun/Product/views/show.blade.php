...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            @can('update', $product)
            <a href="{{ route('product.products.edit', $product) }}" class="btn btn-warning me-2">
    ...
    @if($product->deleted_at)
        <div class="alert alert-warning" role="alert">
            ...
            @can('restore', $product)
            <form action="{{ route('product.products.restore', $product->id) }}" method="POST" class="d-inline ms-2" onsubmit="return confirm('Are you sure you want to restore this product?');">
                @csrf
    ...
    <div class="card">
        ...
        <div class="card-footer text-end">
             @can('delete', $product)
             <form action="{{ route('product.products.destroy', $product) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to (soft) delete this product?');">
                @csrf
                @method('DELETE')
