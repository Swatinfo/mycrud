...
namespace DryRun\Product\Http\Controllers\Api;

use App\Http\Controllers\Controller;
use DryRun\Product\Models\Product;
use DryRun\Product\Http\Requests\ProductRequest;
use DryRun\Product\Http\Resources\ProductResource;
...
class ProductController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $products = \DryRun\Product\Models\Product::latest()->paginate($request->input('per_page', 15));
