...
namespace DryRun\Products\Http\Controllers\Web;
...
class ProductController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->viewPathPrefix = 'products::products';
        $this->routeNamePrefix = 'products.products';
    }
    ...
    {
        // Gate::authorize('viewAny', \DryRun\Products\Models\Product::class);
        ...
        if ($request->ajax()) {
            try {
                ...
                $results = ['data'=>[], 'total'=>0, 'filtered'=>0]; // Service not generated, using DryRun\Products\Models\Product; ; // Service method handles data fetching
    ...
    {
        // Gate::authorize('create', \DryRun\Products\Models\Product::class);
     ...
     *
     * @param  \DryRun\Products\Http\Requests\ProductRequest  $request
     * @return \Illuminate\Http\RedirectResponse
     */
    public function store(ProductRequest $request)
    {
        // Authorization is typically handled by the FormRequest's authorize() method.
        // Or, Gate::authorize('create', \DryRun\Products\Models\Product::class);
        try {
     ...
     *
     * @param  \DryRun\Products\Models\Product  $product
     * @return \Illuminate\Contracts\View\View|\Illuminate\Http\RedirectResponse
     */
    public function show(\DryRun\Products\Models\Product $product) // Route model binding
    {
     ...
     * @return \Illuminate\Contracts\View\View
     */
    public function edit(\DryRun\Products\Models\Product $product)
    {
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function update(ProductRequest $request, \DryRun\Products\Models\Product $product)
    {
        // Authorization is typically handled by the FormRequest's authorize() method.
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function destroy(\DryRun\Products\Models\Product $product)
    {
    ...
    {
        // Gate::authorize('viewAny', \DryRun\Products\Models\Product::class); // Or a specific 'view trashed' permission
        ...
        if ($request->ajax()) {
            try {
                ...
                $results = ['data'=>[], 'total'=>0, 'filtered'=>0]; // Service not generated, using DryRun\Products\Models\Product; ;
    ...
    public function restore(string $id)
    {
        ...
        try {
            $restored = \DryRun\Products\Models\Product::withTrashed()->find($id)?->restore();
            if ($restored) {
                return redirect()->route($this->routeNamePrefix . '.index')
    ...
    public function forceDelete(string $id)
    {
        ...
        try {
            $deleted = \DryRun\Products\Models\Product::withTrashed()->find($id)?->forceDelete();
            if ($deleted) {
