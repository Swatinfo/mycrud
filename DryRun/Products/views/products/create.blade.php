...
<div class="container mt-4">
    ...
    <form action="{{ route('products.products.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                @include('products::products._form', ['product' => new \DryRun\Products\Models\Product()])
            </div>
